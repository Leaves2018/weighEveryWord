...
def first(raw_text):
    familiar_words = []
    with open("/Users/leaves/PycharmProjects/weighEveryWord/familiar/familiar_words.txt", mode='r+', encoding='UTF-8') as fw:
        for line in fw.readlines():
            familiar_words.append(line.strip().lower())

    vocabulary_words = dict()
    with open("/Users/leaves/PycharmProjects/weighEveryWord/vocabulary/vocabulary_words.txt", mode='r+', encoding='UTF-8') as vw:
